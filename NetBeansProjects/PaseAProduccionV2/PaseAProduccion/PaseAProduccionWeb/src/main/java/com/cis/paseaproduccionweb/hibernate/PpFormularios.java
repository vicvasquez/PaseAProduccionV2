...
public class PpFormularios  implements java.io.Serializable {
    ...
    public PpFormularios(BigDecimal formularioId, String flagEstado, String flagUso, String descFormulario, String nombreFormulario, BigDecimal ppsubmenuSubmenuId, BigDecimal ppusuarioUsuarioId, String flagTipo, Blob archivo) {
       this.formularioId = formularioId;
